...
const CreateUserForm: React.FC<CreateUserFormProps> = ({ createUserForm }) => {
  const { handleChange, handleNameChange, handleSubmit, user, errors } =
    useForm(createUserForm, validate);
  ...
  return (
    <div className="position-relative top-50 start-50 translate-middle w-50">
      <form className="text-light" onSubmit={handleSubmit} noValidate>
        <fieldset>
          <legend className="text-center">Animal Lover</legend>
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            />
            {errors.name && (
              <p className="text-danger">{errors.name.surname}</p>
            )}
          </div>
          <div className="mb-3">
          ...
          <div className="position-relative top-100 start-50 translate-middle-x w-50">
            <button
              className="position-relative top-100 start-50 translate-middle-x mb-3 btn btn-primary"
              type="submit"
            >
              Create
            </button>
